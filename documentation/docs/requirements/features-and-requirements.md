...
- Chatbot must have interaction methods (i.e. bot commands, buttons, etc.)


## Nonfunctional Requirements
- Leaderboard must give users an incentive to communicate with each other
- Chatbot must give a human-like and witty impression to users 
